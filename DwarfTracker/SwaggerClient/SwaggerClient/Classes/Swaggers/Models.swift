...
class Decoders {
    ...
    private static var __once: () = {
        ...
        // Decoder for [Dwarf]
        Decoders.addDecoder(clazz: [Dwarf].self) { (source: AnyObject) -> [Dwarf] in
            return Decoders.decode(clazz: [Dwarf].self, source: source)
        }
        // Decoder for Dwarf
        Decoders.addDecoder(clazz: Dwarf.self) { (source: AnyObject) -> Dwarf in
            ...
            instance.age = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["age"] as AnyObject?)
